...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      "flex h-full w-full flex-col overflow-hidden rounded-lg bg-popover text-foreground",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className="flex items-center border-b border-border/60 px-3.5" cmdk-input-wrapper="">
    <Search className="mr-2.5 h-3.5 w-3.5 shrink-0 text-muted-foreground/60" />
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-10 w-full bg-transparent py-3 text-[13px] text-foreground outline-none",
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Group
    ...
    className={cn(
      ...
      "[&_[cmdk-group-heading]]:text-muted-foreground/60 [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-wider",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Separator
    ref={ref}
    className={cn("h-px bg-border/40 mx-1", className)}
    {...props}
  />
));
...
const CommandShortcut = ({
  ...
  <span
    className={cn(
      "ml-auto text-[10px] font-medium text-muted-foreground/50 tracking-widest",
      className
    )}
    {...props}
  />
