...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  if (isMobile) {
    return (
      <div
        ...
        data-mobile="true"
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex h-full w-[--sidebar-width] flex-col bg-sidebar text-sidebar-foreground transition-transform duration-300 ease-in-out",
  ...
  return (
    <div
      ...
      data-side={side}
    >
      {/* Spacer div — reserves width so SidebarInset shifts right */}
      <div
        className={cn(
  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          "inline-flex h-7 w-7 items-center justify-center rounded-md text-sm ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground cursor-pointer",
          className,
        )}
        onClick={(event) => {
          onClick?.(event);
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!p-2 [&>span:last-child]:truncate [&>span:last-child]:transition-[opacity] [&>span:last-child]:duration-150 group-data-[collapsible=icon]:[&>span:last-child]:opacity-0 [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
...
>(({ className, showIcon = false, ...props }, ref) => {
  ...
  return (
    <div
      ...
      {...props}
    >
      {showIcon && <div data-sidebar="menu-skeleton-icon" className="size-4 rounded-md bg-sidebar-accent animate-pulse shrink-0" />}
      <div
